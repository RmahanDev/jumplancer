...
' ====================================================================
'  Jump Lancer - Access database schema builder (v1)
...
Private Const OUTPUT_FILE As String = "jumplancer_db_v1.accdb"
...
Public Sub BuildJumpLancer()
    ...
    F "readiness_score", dbInteger, , True, "0", "Between 0 And 100", "0-100, from assessments and mentor input"
    ...
    F "min_readiness_score", dbInteger, , True, "0", "Between 0 And 100", "Freelancers below this score cannot apply"
    F "deadline", dbDate
    ...
    F "type", dbText, 20, True, , L("deposit,escrow_hold,escrow_release,payout,refund,fee")
    ...
    F "goal", dbMemo
    F "status", dbText, 20, True, Q("requested"), L("requested,active,paused,completed,cancelled")
    F "started_at", dbDate
    F "ended_at", dbDate
    TS
    Save "A mentor-mentee relationship - the core Jump Lancer differentiator."
